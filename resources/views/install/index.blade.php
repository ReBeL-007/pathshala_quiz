               ...
               <form autocomplete="off" action="{{ route('store.step1') }}" id="step1form" method="POST" class="needs-validation" novalidate>
                  ...
                  <div class="form-row">
                    ...
                    <div class="col-md-6 mb-3">
                      ...
                      <input name="APP_NAME" type="text" class="form-control" id="validationCustom01" placeholder="Project_Name |" value="{{ config('app.name') }}" required>
                     ...
                     <div class="col-md-6 mb-3">
                      ...
                      <input name="APP_URL" type="url" class="form-control" id="validationCustom01" placeholder="http://" value="{{ config('app.url') }}">
                      <div class="valid-feedback">
                        Looks good!
                      </div>
                      <div class="invalid-feedback">
                  ...
                  <div class="form-row">
                    <div class="col-md-6 mb-3">
                      ...
                      <input name="MAIL_FROM_NAME" type="text" class="form-control" id="validationCustom03" placeholder="Example_Name" required value="{{ config('mail.from.name') }}">
                      <div class="invalid-feedback">
                    ...
                    <div class="col-md-6 mb-3">
                      ...
                      <input type="text" name="MAIL_FROM_ADDRESS" class="form-control" id="validationCustom04" placeholder="eg: info@example.com" required value="{{ config('mail.from.address') }}">
                      <div class="invalid-feedback">
                    ...
                    <div class="col-md-6 mb-3">
                      ...
                      <input name="MAIL_USERNAME" type="text" class="form-control" id="validationCustom05" placeholder="eg: info@example.com" required value="{{ config('mail.mailers.smtp.username') }}">
                      <div class="invalid-feedback">
                     ...
                     <div class="eyeCy col-md-6 mb-3">
                      ...
                      <input name="MAIL_PASSWORD" type="password" placeholder="*******" class="form-control" id="validationCustom06" required value="{{ config('mail.mailers.smtp.password') }}">
                    ...
                    <div class="col-md-6 mb-3">
                      ...
                      <input name="MAIL_HOST" type="text" placeholder="mail.example.com" class="form-control" id="validationCustom07" required value="{{ config('mail.mailers.smtp.host') }}">
                      <div class="invalid-feedback">
                    ...
                    <div class="eyeCy col-md-6 mb-3">
                      ...
                      <input name="MAIL_PORT" type="password" placeholder="587" class="form-control" id="validationCustom08" required value="{{ config('mail.mailers.smtp.port') }}">
                    ...
                    <div class="col-md-6 mb-3">
                      ...
                      <input name="MAIL_DRIVER" type="text" placeholder="smtp" class="form-control" id="validationCustom09" required value="{{ config('mail.default') }}">
                      <div class="invalid-feedback">
                    ...
                    <div class="col-md-6 mb-3">
                      ...
                      <input name="MAIL_ENCRYPTION" type="text" placeholder="TLS" class="form-control" id="validationCustom10" value="{{ config('mail.mailers.smtp.encryption') }}">
